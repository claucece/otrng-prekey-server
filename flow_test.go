...
func generateSitaClientProfile(longTerm *gotrax.Keypair) *gotrax.ClientProfile {
	...
	sita.Sig = gotrax.CreateEddsaSignature([114]byte{
		0xc9, 0x85, 0x49, 0xd5, 0x46, 0x92, 0xde, 0x73,
		0xe4, 0x5d, 0xc1, 0xdb, 0x7e, 0x8e, 0x3c, 0x3d,
		0x58, 0x22, 0xea, 0xe9, 0x35, 0xc9, 0xf8, 0xcb,
		0x55, 0xb0, 0x78, 0x40, 0x6a, 0x9d, 0xaa, 0x8a,
		0x52, 0xc7, 0xf2, 0xb3, 0xfb, 0xb0, 0xb3, 0x23,
		0x7c, 0xf1, 0xf2, 0xfe, 0xbc, 0x82, 0x70, 0x65,
		0x0c, 0x39, 0x9f, 0x46, 0xd7, 0x85, 0xf0, 0xae,
		0x80, 0x27, 0x9a, 0x55, 0x78, 0x23, 0xf1, 0x1c,
		0x3b, 0x97, 0x71, 0x0a, 0x7b, 0xfe, 0x5a, 0x05,
		0xec, 0x18, 0x1a, 0x1e, 0xa8, 0x09, 0xc7, 0xcf,
		0x22, 0x0d, 0x9f, 0x03, 0x83, 0xb3, 0xc4, 0xf2,
		0x42, 0x2c, 0xee, 0xf9, 0xf6, 0x39, 0x95, 0x60,
		0x7b, 0x9a, 0x8c, 0xf5, 0xd2, 0xab, 0xf0, 0x69,
		0x93, 0x6a, 0x53, 0x90, 0xb0, 0xd5, 0xff, 0x73,
		0x1a, 0x00,
	})
	return sita
}
...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(gotrax.SerializePoint(d2.serverKey), DeepEquals, []byte{
		...
		0x5d, 0x07, 0xbb, 0xe1, 0xab, 0xe9, 0xc7, 0xaf,
		0xc3, 0x5b, 0x16, 0x54, 0x1c, 0x6a, 0xf2, 0x6c,
		0xc7, 0x6a, 0xa7, 0xba, 0xf5, 0xf0, 0x7e, 0x8b,
		0x26, 0x36, 0xe4, 0xe6, 0x66, 0x6b, 0x9f, 0x96,
		0xbd, 0x47, 0x00, 0xd4, 0xe6, 0x9f, 0x07, 0x9e,
		0x0,
	})
	c.Assert(d2.s.DSAEncode(), DeepEquals, []byte{
		0x6d, 0xf0, 0x8d, 0xf3, 0x08, 0x94, 0x3a, 0xa0,
		0xb6, 0xed, 0x29, 0xc0, 0xeb, 0xd2, 0x69, 0x74,
		0xa7, 0xb9, 0xcc, 0x53, 0x04, 0xea, 0xf8, 0x89,
		0x73, 0xa6, 0x35, 0x62, 0x06, 0xc5, 0xd3, 0x26,
	...
	c.Assert(d2.sigma.C1.Encode(), DeepEquals, []byte{
		...
		0x05, 0xfa, 0xc0, 0x93, 0xf5, 0x5d, 0x64, 0xca,
		0x22, 0x8d, 0x27, 0x22, 0x6c, 0xf6, 0x59, 0xd9,
		0xb3, 0x31, 0x31, 0x73, 0x10, 0xb4, 0x6e, 0xc6,
		0x17, 0xba, 0x5f, 0x91, 0xdd, 0x31, 0xb5, 0x09,
		0x83, 0x01, 0x51, 0x7c, 0x08, 0x2e, 0x1c, 0x33})

	c.Assert(d2.sigma.R1.Encode(), DeepEquals, []byte{
		0x47, 0x71, 0x5b, 0x81, 0xa8, 0x56, 0x47, 0x16,
		0x05, 0x8f, 0x9a, 0x2e, 0x9b, 0x2c, 0x55, 0xc3,
		0xd7, 0x00, 0xd3, 0x26, 0x13, 0xf5, 0x93, 0xe4,
		0xf4, 0xcb, 0x98, 0xb7, 0xe7, 0x81, 0x0d, 0x35,
		0xa7, 0xa5, 0x59, 0x74, 0x9b, 0x7d, 0x19, 0x63,
		0x20, 0x5c, 0x01, 0x3b, 0x79, 0x70, 0x35, 0x33,
		0xfa, 0x1f, 0x38, 0xe3, 0x81, 0x96, 0x78, 0x2e})

	c.Assert(d2.sigma.C2.Encode(), DeepEquals, []byte{
		0xb7, 0xc5, 0x4e, 0x86, 0x25, 0x38, 0x40, 0x8f,
		0x61, 0x45, 0x3b, 0x7f, 0x04, 0x97, 0x88, 0x19,
		0xe1, 0xda, 0x36, 0x21, 0x8f, 0xcf, 0x08, 0x94,
		0xd6, 0xd6, 0xba, 0xf7, 0x5b, 0x68, 0x38, 0x0a,
		0xa2, 0x93, 0x5f, 0x10, 0x55, 0x27, 0xf2, 0x61,
		0x27, 0x55, 0x3b, 0x42, 0xc1, 0x53, 0x94, 0xa7,
		0x01, 0x99, 0x98, 0x31, 0x6d, 0xa5, 0x15, 0x3a})

	c.Assert(d2.sigma.R2.Encode(), DeepEquals, []byte{
		0xc6, 0xa2, 0x3d, 0xa7, 0x90, 0x1a, 0x82, 0x2a,
		0x39, 0x72, 0x04, 0xf1, 0xff, 0x4e, 0x74, 0x2d,
		0x04, 0x79, 0x35, 0x33, 0x7e, 0xef, 0x30, 0xa2,
		0x50, 0x3b, 0xec, 0x02, 0x43, 0xcf, 0xfa, 0x44,
		0x41, 0x84, 0x7c, 0xda, 0xff, 0x35, 0xcc, 0x4c,
		0xb6, 0x7f, 0x74, 0xd5, 0xd0, 0x47, 0x12, 0xfa,
		0xc7, 0x3d, 0xc9, 0x78, 0xe0, 0x57, 0xb3, 0x0a})
	...
	c.Assert(d2.sigma.C3.Encode(), DeepEquals, []byte{
		...
		0x6e, 0x73, 0xfb, 0x08, 0x1f, 0x92, 0xb4, 0x88,
		0x85, 0x50, 0x0d, 0xe4, 0x26, 0x9a, 0x3b, 0x86,
